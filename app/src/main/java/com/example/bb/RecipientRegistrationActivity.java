                                ...
                                if(resultUri != null)
                                {
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(RecipientRegistrationActivity.this,"Imge Upload Failed..!!", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful())
                                                                {
                                                                    Toast.makeText(RecipientRegistrationActivity
                                                                            .this,"Image url addedd to database successful", Toast.LENGTH_SHORT).show();
                                                                }
