...
import com.example.bb.Adapter.UserAdapter;
import com.example.bb.Model.User;
    ...
    private void readDonars() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userList.isEmpty())
                {
                    Toast.makeText(MainActivity.this,"No Donars" , Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
